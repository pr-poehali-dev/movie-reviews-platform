...
const Movie = () => {
  ...
  const movieData: Record<string, any> = {
    '1': {
      ...
      plot: 'В новом фильме Пола Томаса Андерсона Леонардо Ди Каприо в очередной раз отказывается от образа харизматичного героя. Вместо этого — Роберт, мужчина средних лет, мягкий, растерянный, работающий охранником на заброшенной электростанции в приграничном городке, где напряжение между мигрантами, местными жителями и правоохранительными структурами вот-вот взорвётся. Это не экшен-триллер с взрывами и погонями, а скорее социальная драма, где каждый выстрел звучит как метафора неравенства, страха и одиночества.',
      cast: [
        'Леонардо ДиКаприо',
        'Шон Пенн',
        'Чейз Инфинити',
