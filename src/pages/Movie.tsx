...
const Movie = () => {
  ...
  const movieData: Record<string, any> = {
    ...
    '2': {
      ...
      budget: '$38 000 000',
      duration: 'н/д',
      releaseDate: '2 октября 2025',
      image: '/img/a2c85fb4-908d-40c4-b94d-b7a6432abdf4.jpg',
      cover: '/img/a2c85fb4-908d-40c4-b94d-b7a6432abdf4.jpg',
      tagline: '17 исчезновений. Одна ночь. Один выживший.',
      description: 'Однажды ночью в небольшом городке 17 младшеклассников одновременно убежали из дома и бесследно исчезли. Все они учились в одном классе, и кроме них не пропал только один мальчик. Уже месяц полиция не может найти никаких зацепок, а безутешные родители считают, что с этим как-то связана новая классная руководительница.',
      plot: 'Напряженный психологический хоррор-детектив, который держит в напряжении от первой до последней минуты. Зак Креггер создает атмосферу нарастающего ужаса в, казалось бы, обычном американском городке. Каждая деталь имеет значение, а разгадка окажется страшнее самых жутких предположений.',
      cast: [
        'Джулия Гарнер',
        'Джош Бролин',
        'Олден Эренрайк',
